...
export class SearchFlightsComponent implements OnInit {
  ...
  dep: string = "lon";
  arr: string = "del";
  depdat: string = "10102019"; arrdat: string = "17102019";
  constructor(private find: SearchService, private elementRef: ElementRef,
    private fb: FormBuilder, private _dataService: SearchService, private router: Router) {
  ...
  /**for url in Search Page
   onSearch(source: string, dest: string, depdate: string, arrivaldate: string)
   ,'del','10102019','17102019'
   *
   */
